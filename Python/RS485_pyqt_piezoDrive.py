...
class App(QDialog):
    ...
    def createGridLayout(self): #Build GUI
       ...
       #Phase
        ...
        #Add widgets to grid
        layout.addWidget(self.pauseLabel, 19,0)
        layout.addWidget(self.pauseValue, 19,1)
        layout.addWidget(self.enablepauseButton, 19,2)
        layout.addWidget(self.disablepauseButton, 19,3)
